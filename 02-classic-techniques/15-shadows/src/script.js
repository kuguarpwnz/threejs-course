...
// directionalLight.shadow.radius = 20 // does not work with PCFSoftShadowMap
...
const spotLight = new THREE.SpotLight('#ffffff', 2, 10, Math.PI * 0.3)
...
const plane = new THREE.Mesh(
    ...
    material
    // new THREE.MeshBasicMaterial({ map: bakedShadowTexture }) // for baked shadow
)
...
const sphereShadow = new THREE.Mesh(
    ...
    new THREE.MeshBasicMaterial({ color: '#000000', alphaMap: simpleShadowTexture, transparent: true })
)
